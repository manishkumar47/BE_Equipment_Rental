import { pgEnum, pgTable, serial, text, timestamp, integer, boolean, doublePrecision, uniqueIndex, index, } from "drizzle-orm/pg-core";
...
export const rentalBooking = pgTable("rental_bookings", {
    id: serial("id").primaryKey(),
    ...
    index("rental_bookings_reminder_idx").on(table.isReminderSent, table.isDeleted, table.rentFrom, table.rentTo),
]);
