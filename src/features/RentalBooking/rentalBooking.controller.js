...
export const createRentalBooking = async (req, res, next) => {
    try {
        ...
        const createRentalBookingObject = {
            userId,
            equipmentId,
            rentTo,
            rentFrom,
        ...
        const rentalBooking = await rentalBookingService.createRentalBooking(createRentalBookingObject);
        if (!rentalBooking) {
...
//# sourceMappingURL=rentalBooking.controller.js.map