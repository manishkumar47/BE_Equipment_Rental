...
import { loginSchema, forgotPasswordSchema, resetPasswordSchema, } from "../features/Auth/auth.schema.js";
 ...
 */
authRouter.post("/login", loginRateLimiter, validate(loginSchema), authController.loginUser);
/**
 * @openapi
 * /auth/signup:
 *   post:
 ...
 *         description: Internal server error
 */
authRouter.post("/signup", registerRateLimiter, validate(userSchema), userController.createUser);
/**
 * @openapi
 * /auth/reset-password:
 *   post:
