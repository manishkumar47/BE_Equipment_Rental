 ...
 */
equipmentRouter.post("/", isAdmin, generalRateLimiter, validate(equipmentSchema), equipmentController.createEquipment);
/**
 * @openapi
 * /equipments:
 *   get:
 ...
 *         description: Internal server error
 */
equipmentRouter.get("/", generalRateLimiter, equipmentController.getAllEquipments);
/**
 * @openapi
 * /equipments/{id}:
 *   put:
 ...
 *         description: Internal server error
 */
equipmentRouter.put("/:id", isAdmin, generalRateLimiter, validate(equipmentSchema.partial()), equipmentController.updateEquipment);
/**
 * @openapi
 * /equipments/{id}:
 *   delete:
 ...
 *         description: Internal server error
 */
equipmentRouter.delete("/:id", isAdmin, generalRateLimiter, equipmentController.deleteEquipment);
